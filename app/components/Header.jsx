...
const Header = () => {
  return (
    ...
    items-center justify-center gap-4'>
      ...
      <motion.h3
       ...
       className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
            Hi! I'm Daniel Bonami <Image src={assets.hand_icon} alt=''
    ...
    className='text-3x1 sm:text-6xl lg:text-[66px] font-Ovo'>
         Web developer based in Lewisville, TX.</motion.h1>
        ...
        As a web developer with hands-on experience in designing, developing, and maintaining 
