...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    dark:hidden'>
      ...
      flex items-center justify-between z-50 {isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg 
      shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
        ...
        rounded-full px-12 py-3 {isScroll ? "" : "bg-white shadow-sm bg-opacity-50 dark border
        ...
        duration-500 dark:bg-darkHover dark:text-white'>
            ...
            <li><a className='font-Ovo' onClick={closeMenu} 
